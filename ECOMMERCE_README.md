...
To log in, use one of the demo accounts: `C001`, `C002`, or `C003`.
...
Recommendations are based on what categories you've ordered from before — it just finds other in-stock stuff from those same categories and sorts by rating.
